      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('bootstrap4-light-blue', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('bootstrap4-light-purple', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('bootstrap4-dark-blue', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('bootstrap4-dark-purple', true)"
          >
            <img
              class="block"
      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('md-light-indigo', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('md-light-deeppurple', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('md-dark-indigo', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('md-dark-deeppurple', true)"
          >
            <img
              class="block"
      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('mdc-light-indigo', false)"
          >
            <img
              class="block"
              src="images/themes/md-light-indigo.svg"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('mdc-light-deeppurple', false)"
          >
            <img
              class="block"
              src="images/themes/md-light-deeppurple.svg"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('mdc-dark-indigo', true)"
          >
            <img
              class="block"
              src="images/themes/md-dark-indigo.svg"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('mdc-dark-deeppurple', true)"
          >
            <img
              class="block"
              src="images/themes/md-dark-deeppurple.svg"
      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('tailwind-light', false)"
          >
            <img
              class="block"
      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('fluent-light', false)"
          >
            <img
              class="block"
      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-light-indigo', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-light-blue', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-light-purple', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-light-teal', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-dark-indigo', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-dark-blue', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-dark-purple', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('lara-dark-teal', true)"
          >
            <img
              class="block"
      ...
      <div class="grid free-themes">
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('saga-blue', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('saga-green', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('saga-orange', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('saga-purple', false)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('vela-blue', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('vela-green', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('vela-orange', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('vela-purple', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('arya-blue', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('arya-green', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('arya-orange', true)"
          >
            <img
              class="block"
        ...
        <div class="col-3 text-center">
          <button
            class="p-link"
            type="button"
            @click="changeTheme('arya-purple', true)"
          >
            <img
              class="block"
